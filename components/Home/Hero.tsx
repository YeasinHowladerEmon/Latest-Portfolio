...
export function Hero() {
  return (
    ...
    >
      ...
      {/* Grid background */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#0f0f0f_1px,transparent_1px),linear-gradient(to_bottom,#0f0f0f_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_70%,transparent_110%)] opacity-30" />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              {/* Geometric shapes */}
              <motion.div
                className="absolute top-0 right-0 w-32 h-32 border-4 border-lime-400"
                animate={{ rotate: 360 }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
              />
              <motion.div
                className="absolute bottom-0 left-0 w-24 h-24 border-4 border-fuchsia-500"
                animate={{ rotate: -360 }}
                transition={{ duration: 15, repeat: Infinity, ease: "linear" }}
              />
              <motion.div
                className="relative z-10 w-full h-96 bg-gradient-to-br from-lime-400/10 to-fuchsia-500/10 backdrop-blur-sm border-2 border-white/10 flex items-center justify-center"
                animate={{
                  boxShadow: [
                    '0 0 20px rgba(163, 230, 53, 0.3)',
                    '0 0 60px rgba(217, 70, 239, 0.3)',
                ...
                transition={{ duration: 3, repeat: Infinity }}
              >
                <div className="text-white/10 text-9xl font-black">DEV</div>
              </motion.div>
            </div>
          </motion.div>
        </div>
